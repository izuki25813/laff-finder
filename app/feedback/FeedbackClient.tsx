              ...
              return (
                <div key={index} className={`rounded-xl border p-5 ${fb.Tipo === "Sugestão" ? "bg-blue-950/20 border-blue-900/50" : "bg-red-950/20 border-red-900/50"}`}>
                  ...
                  <div className="flex gap-2">
                    <button onClick={() => handleVote(index, "like")} className="flex items-center gap-2 bg-zinc-800 hover:bg-green-900/50 text-zinc-300 hover:text-green-400 px-4 py-2 rounded-lg text-sm font-bold transition">
                      👍 <span className="font-black">{likes}</span>
                    </button>
                    <button onClick={() => handleVote(index, "deslike")} className="flex items-center gap-2 bg-zinc-800 hover:bg-red-900/50 text-zinc-300 hover:text-red-400 px-4 py-2 rounded-lg text-sm font-bold transition">
