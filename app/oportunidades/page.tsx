        ...
        <div className="flex flex-col min-h-screen">
          <section className="flex-1 flex flex-col items-center justify-center px-6 py-20 text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 w-full max-w-6xl">
              ...
              {/* 6. Oportunidades (NOVO HUB!) */}
              <Link href="/oportunidades" className="rounded-xl border-2 border-yellow-400 bg-gradient-to-br from-yellow-900/30 to-black px-6 py-5 font-bold text-white transition hover:scale-[1.02] hover:shadow-lg hover:shadow-yellow-400/20 flex flex-col items-center gap-2">
                <span className="text-3xl">🎯</span>
                <span>Oportunidades</span>
                <span className="text-[10px] uppercase tracking-wider text-yellow-400 font-black">Testes, Orgs e Campeonatos</span>
              </Link>
