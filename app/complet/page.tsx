        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 mb-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <input required value={form.nick} onChange={e => setForm({...form, nick: e.target.value})} placeholder="Seu Nick *" className="bg-black border border-zinc-700 rounded-lg p-3 text-white focus:border-yellow-400 outline-none" />
              <input required value={form.contato} onChange={e => setForm({...form, contato: e.target.value})} type="tel" placeholder="WhatsApp (ex: 11999999999) *" className="bg-black border border-zinc-700 rounded-lg p-3 text-white focus:border-yellow-400 outline-none" />
            </div>
            ...
            {activeTab === "disponivel" ? (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <input required value={form.hFim} onChange={e => setForm({...form, hFim: e.target.value})} placeholder="Até que horas? (ex: 23:00) *" className="bg-black border border-zinc-700 rounded-lg p-3 text-white focus:border-yellow-400 outline-none" />
              </div>
            ) : (
            ...
            <div className="bg-yellow-900/20 border border-yellow-600/30 rounded-lg p-4">
              ...
              <input required value={form.pin} onChange={e => setForm({...form, pin: e.target.value})} maxLength={4} placeholder="Ex: 1234" className="w-full bg-black border border-zinc-700 rounded-lg p-3 text-white focus:border-yellow-400 outline-none tracking-widest text-center text-xl font-black" />
            </div>
